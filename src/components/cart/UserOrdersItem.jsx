        ...
        >
          ...
          <div className="text-center">
            <p>
              ...
              <b>
                {order?.region} - {order?.comuna} - En la calle {order?.address}
              </b>
            </p>
            <p>
              Productos: {order?.details.map((detail) => detail + " ")}{" "}
              {order?.selectedAccesories !== null ? (
                <span> + {order.selectedAccesories} Accesorios</span>
              ) : (
                <span></span>
              )}
            </p>
          ...
          <div className={`${statusClass}`}>
            <b>
              Estado: <span>{statusIcons}</span> {order?.status.toUpperCase()}
            </b>
            {order?.status === "En Camino" ? (
              <div className="mt-3">
                <p className="text-dark">
                  <b>Sigue tu compra en </b>
                  <br />
                  <a href="https://www.starken.cl" target="_blank">
